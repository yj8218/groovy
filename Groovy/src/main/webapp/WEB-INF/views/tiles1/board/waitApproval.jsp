...
<body>
	...
	<div id="container">
		...
		<div style="font-size: 20px; font-weight: bold; margin: 20px 0;">결재 대기 문서</div>
			<table id="myAppInfo" class="tcenter">
				...
				<c:if test="${not empty requestScope.waitApprovalList }">
					<c:forEach var="appList" items="${requestScope.waitApprovalList }" >
						<tr class="selectOne">
							<td>${appList.rno }</td>
				...
				<c:if test="${empty requestScope.waitApprovalList }">
					<tr>
