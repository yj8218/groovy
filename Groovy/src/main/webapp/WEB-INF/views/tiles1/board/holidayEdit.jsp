...
input.date {
	...
	<!-- 제이쿼리 타임피커 -->
    <link rel="stylesheet" href="<%= ctxPath%>/resources/jquery-timepicker-1.3.5/jquery.timepicker.min.css">

	<script type="text/javascript" src="<%= ctxPath%>/resources/js/jquery-3.6.0.min.js"></script>
	<script type="text/javascript" src="<%= ctxPath%>/resources/bootstrap-4.6.0-dist/js/bootstrap.bundle.min.js" ></script>
	<script type="text/javascript" src="<%= ctxPath%>/resources/jquery-ui-1.13.1.custom/jquery-ui.js" ></script>
	<script src="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script> 
	<script src="<%= ctxPath%>/resources/jquery-timepicker-1.3.5/jquery.timepicker.min.js"></script>
...
<div id="container">
		...
		<div class="title">
			<i class="fas fa-umbrella-beach fa-2x"></i> <span class="title">휴가신청</span>
		</div>
